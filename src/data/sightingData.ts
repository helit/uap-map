...
export const sightingData: SightingInfoType[] = [
    ...
    },
    {
        ...
        description: `During the build-up to the Second Punic War, Livy recorded prodigies in the winter sky, including navium speciem de caelo adfulsisse ("phantom ships had been seen gleaming in the sky").`,
    },
    {
        id: '93',
        date: '76 BC',
        ...
        description: `According to Pliny the Elder, a spark fell from a star and grew as it descended until it appeared to be the size of the Moon. It then ascended back up to the heavens and was transformed into a torch. Astronomer Richard Stothers interpreted the report as a description of a bolide.`,
    },
    {
        id: '94',
        date: '7 BC',
        ...
        description: `According to Plutarch, a Roman army commanded by Lucullus was about to begin a battle with Mithridates VI of Pontus when "the sky burst asunder, and a huge, flame-like body was seen to fall between the two armies". Plutarch reports the shape of the object as like a wine-jar (pithos).`,
    },
    {
        id: '95',
        date: 'AD 65',
        ...
        description: `Romano-Jewish historian Flavius Josephus reported chariots "hurtling through the clouds" prior to the First Jewish–Roman War.`,
    },
    {
        id: '96',
        date: 'AD 196',
        ...
        description: `Historian Cassius Dio described "A fine rain resembling silver descended from a clear sky upon the Forum of Augustus." He used some of the material to plate some of his bronze coins, but by the fourth day afterwards, the silvery coating was gone.`,
    },
    {
        id: '97',
        date: 'AD 740',
